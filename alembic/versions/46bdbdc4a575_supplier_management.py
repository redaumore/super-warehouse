...
down_revision: str | None = "5f304e18a765"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

supplier_status = postgresql.ENUM("ACTIVO", "INACTIVO", name="supplier_status", create_type=False)
...
def upgrade() -> None:
    ...
    op.alter_column("supplier_sku_mappings", "descripcion_raw", new_column_name="raw_description")

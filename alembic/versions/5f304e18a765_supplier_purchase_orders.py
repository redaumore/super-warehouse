...
down_revision: Union[str, None] = 'a0bf3bd210f8'
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.ENUM(
                'OPEN', 'SENT', 'PARTIALLY_RECEIVED', 'FULLY_RECEIVED',
                'CANCELLED', name='supplier_purchase_order_state',
                create_type=False,
            ),
            server_default='OPEN',
            nullable=False,
        ...
        sa.ForeignKeyConstraint(['supplier_id'], ['proveedores.proveedor_id'], ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['po_id'], ['supplier_purchase_orders.po_id'], ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['po_item_id'], ['supplier_purchase_order_items.po_item_id'], ),
        sa.ForeignKeyConstraint(['supplier_id'], ['proveedores.proveedor_id'], ),

...
class Settings(BaseSettings):
    ...
    # Vision-LLM remito parse takes 30-90s on real WhatsApp photos; the 15s
    # default aborted legitimate parses with "timed out" (rag-api itself has
    # no OpenAI timeout, so the client was the only ceiling).
